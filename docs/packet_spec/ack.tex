\begin{table}[H]
    ...
    \hline
    \multicolumn{34}{|c|}{\textbf{ACK Packet}} \\ \hline
    \textit{\textbf{Offsets}} &
    ...
    \multicolumn{1}{|c|}{\textbf{8}} &
      ...
      \multicolumn{16}{c|}{\cellcolor[HTML]{FFDDDD}ACK ID} \\ \hline
    \multicolumn{1}{|c|}{\textbf{12}} &
      \multicolumn{1}{c|}{\textbf{96}} &
      \multicolumn{16}{c|}{\cellcolor[HTML]{FFDDDD}ACK Bits} &
      \multicolumn{16}{c|}{\cellcolor[HTML]{F9DDFF}\textit{Data*}} \\ \hline
    \end{tabular}%
    }
\end{table}